...
#'
#'
#'@return \code{cournot_tariff} returns an instance of \link[antitrust]{Cournot-class} from package \pkg{antitrust}, depending upon the value of the ``demand'' argument.
